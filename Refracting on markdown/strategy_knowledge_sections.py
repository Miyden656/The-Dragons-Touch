...
from reports.legacy.strategy_v1_4_regression_lock_candidate import build_v1_4_regression_report_section, build_v1_4_regression_prompt_block, build_v1_4_regression_viewer_summary  # v1.4.27 full regression
from reports.legacy.land_deck_write_integration import build_land_deck_write_report_section, build_land_deck_write_prompt_block, build_land_deck_write_viewer_summary  # v1.4.24 land deck-write
from reports.legacy.finished_mana_base_generation import build_finished_mana_base_report_section, build_finished_mana_base_prompt_block, build_finished_mana_base_viewer_summary  # v1.4.23 finished mana base
from reports.legacy.full_100_card_draft_preview import build_full_100_card_draft_report_section, build_full_100_card_draft_prompt_block, build_full_100_card_draft_viewer_summary  # v1.4.19 full 100-card draft preview
from reports.legacy.exact_card_candidate_preview import build_exact_card_candidate_report_section, build_exact_card_candidate_prompt_block, build_exact_card_candidate_viewer_summary  # v1.4.15 exact card candidate preview
from reports.legacy.strategy_shell_planning import build_strategy_shell_report_section, build_strategy_shell_prompt_block, build_strategy_shell_viewer_summary  # v1.4.14 shell planning
...
def _v1_4_40_7_3_active_strategy_status_payload(context=None):
    try:
        from reports.legacy.strategy_knowledge_active_scoring import score_strategy_profiles
...
def build_v1_4_33_1_live_profile_status_report_appendix(context=None):
    try:
        from reports.legacy.strategy_knowledge_live_profile_status import build_live_profile_status_report_section
...
def build_v1_4_33_1_live_profile_status_prompt_appendix(context=None):
    try:
        from reports.legacy.strategy_knowledge_live_profile_status import build_live_profile_status_prompt_block
...
def build_v1_4_35_active_scoring_report_section(context=None):
    from reports.legacy.strategy_knowledge_active_scoring import build_active_scoring_report_section
    return build_active_scoring_report_section(context or {})

def build_v1_4_35_active_scoring_prompt_block(context=None):
    from reports.legacy.strategy_knowledge_active_scoring import build_active_scoring_prompt_block
    return build_active_scoring_prompt_block(context or {})

def build_v1_4_35_active_scoring_viewer_summary():
    from reports.legacy.strategy_knowledge_active_scoring import build_active_scoring_viewer_summary
...
def build_v1_4_39_player_facing_strategy_status_block(context=None):
    from reports.legacy.batch_output_strategy_status_polish import build_player_facing_strategy_status_block
    return build_player_facing_strategy_status_block(context or {})

def build_v1_4_39_batch_global_strategy_status_block():
    from reports.legacy.batch_output_strategy_status_polish import build_batch_global_strategy_status_block
    return build_batch_global_strategy_status_block()

def sanitize_v1_4_39_player_facing_strategy_text(text):
    from reports.legacy.batch_output_strategy_status_polish import sanitize_player_facing_strategy_text
...
def build_active_scoring_report_section(context=None, *args, **kwargs):
    return _v1_4_40_6_report("active_scoring", "reports.legacy.strategy_knowledge_active_scoring", "build_active_scoring_report_section", context, *args, **kwargs)

def build_active_scoring_prompt_block(context=None, *args, **kwargs):
    return _v1_4_40_6_prompt("active_scoring", "reports.legacy.strategy_knowledge_active_scoring", "build_active_scoring_prompt_block", context, *args, **kwargs)

def build_active_scoring_viewer_summary(context=None, *args, **kwargs):
    return _v1_4_40_6_viewer("active_scoring", "reports.legacy.strategy_knowledge_active_scoring", "build_active_scoring_viewer_summary", context, *args, **kwargs)

def build_live_profile_status_report_section(context=None, *args, **kwargs):
    return _v1_4_40_6_report("live_profile_status", "reports.legacy.strategy_knowledge_live_profile_status", "build_live_profile_status_report_section", context, *args, **kwargs)

def build_live_profile_status_prompt_block(context=None, *args, **kwargs):
    return _v1_4_40_6_prompt("live_profile_status", "reports.legacy.strategy_knowledge_live_profile_status", "build_live_profile_status_prompt_block", context, *args, **kwargs)

def build_live_profile_status_viewer_summary(context=None, *args, **kwargs):
    return _v1_4_40_6_viewer("live_profile_status", "reports.legacy.strategy_knowledge_live_profile_status", "build_live_profile_status_viewer_summary", context, *args, **kwargs)

def build_strategy_shell_report_section(context=None, *args, **kwargs):
    return _v1_4_40_6_report("strategy_shell", "reports.legacy.strategy_shell_planning", "build_strategy_shell_report_section", context, *args, **kwargs)

def build_strategy_shell_prompt_block(context=None, *args, **kwargs):
    return _v1_4_40_6_prompt("strategy_shell", "reports.legacy.strategy_shell_planning", "build_strategy_shell_prompt_block", context, *args, **kwargs)

def build_strategy_shell_viewer_summary(context=None, *args, **kwargs):
    return _v1_4_40_6_viewer("strategy_shell", "reports.legacy.strategy_shell_planning", "build_strategy_shell_viewer_summary", context, *args, **kwargs)

def build_exact_card_candidate_report_section(context=None, *args, **kwargs):
    return _v1_4_40_6_report("exact_card_candidate", "reports.legacy.exact_card_candidate_preview", "build_exact_card_candidate_report_section", context, *args, **kwargs)

def build_exact_card_candidate_prompt_block(context=None, *args, **kwargs):
    return _v1_4_40_6_prompt("exact_card_candidate", "reports.legacy.exact_card_candidate_preview", "build_exact_card_candidate_prompt_block", context, *args, **kwargs)

def build_exact_card_candidate_viewer_summary(context=None, *args, **kwargs):
    return _v1_4_40_6_viewer("exact_card_candidate", "reports.legacy.exact_card_candidate_preview", "build_exact_card_candidate_viewer_summary", context, *args, **kwargs)
...
def build_mana_base_report_section(context=None, *args, **kwargs):
    return _v1_4_40_6_report("mana_base", "reports.legacy.mana_base_planning", "build_mana_base_report_section", context, *args, **kwargs)

def build_mana_base_prompt_block(context=None, *args, **kwargs):
    return _v1_4_40_6_prompt("mana_base", "reports.legacy.mana_base_planning", "build_mana_base_prompt_block", context, *args, **kwargs)

def build_mana_base_viewer_summary(context=None, *args, **kwargs):
    return _v1_4_40_6_viewer("mana_base", "reports.legacy.mana_base_planning", "build_mana_base_viewer_summary", context, *args, **kwargs)

def build_land_insertion_report_section(context=None, *args, **kwargs):
    return _v1_4_40_6_report("land_insertion", "reports.legacy.land_insertion_preview", "build_land_insertion_report_section", context, *args, **kwargs)

def build_land_insertion_prompt_block(context=None, *args, **kwargs):
    return _v1_4_40_6_prompt("land_insertion", "reports.legacy.land_insertion_preview", "build_land_insertion_prompt_block", context, *args, **kwargs)

def build_land_insertion_viewer_summary(context=None, *args, **kwargs):
    return _v1_4_40_6_viewer("land_insertion", "reports.legacy.land_insertion_preview", "build_land_insertion_viewer_summary", context, *args, **kwargs)

def build_full_100_card_draft_report_section(context=None, *args, **kwargs):
    return _v1_4_40_6_report("full_100_card_draft", "reports.legacy.full_100_card_draft_preview", "build_full_100_card_draft_report_section", context, *args, **kwargs)

def build_full_100_card_draft_prompt_block(context=None, *args, **kwargs):
    return _v1_4_40_6_prompt("full_100_card_draft", "reports.legacy.full_100_card_draft_preview", "build_full_100_card_draft_prompt_block", context, *args, **kwargs)

def build_full_100_card_draft_viewer_summary(context=None, *args, **kwargs):
    return _v1_4_40_6_viewer("full_100_card_draft", "reports.legacy.full_100_card_draft_preview", "build_full_100_card_draft_viewer_summary", context, *args, **kwargs)

def build_final_inclusion_lock_report_section(context=None, *args, **kwargs):
    return _v1_4_40_6_report("final_inclusion_lock", "reports.legacy.final_inclusion_lock", "build_final_inclusion_lock_report_section", context, *args, **kwargs)

def build_final_inclusion_lock_prompt_block(context=None, *args, **kwargs):
    return _v1_4_40_6_prompt("final_inclusion_lock", "reports.legacy.final_inclusion_lock", "build_final_inclusion_lock_prompt_block", context, *args, **kwargs)

def build_final_inclusion_lock_viewer_summary(context=None, *args, **kwargs):
    return _v1_4_40_6_viewer("final_inclusion_lock", "reports.legacy.final_inclusion_lock", "build_final_inclusion_lock_viewer_summary", context, *args, **kwargs)

def build_finished_mana_base_report_section(context=None, *args, **kwargs):
    return _v1_4_40_6_report("finished_mana_base", "reports.legacy.finished_mana_base_generation", "build_finished_mana_base_report_section", context, *args, **kwargs)

def build_finished_mana_base_prompt_block(context=None, *args, **kwargs):
    return _v1_4_40_6_prompt("finished_mana_base", "reports.legacy.finished_mana_base_generation", "build_finished_mana_base_prompt_block", context, *args, **kwargs)

def build_finished_mana_base_viewer_summary(context=None, *args, **kwargs):
    return _v1_4_40_6_viewer("finished_mana_base", "reports.legacy.finished_mana_base_generation", "build_finished_mana_base_viewer_summary", context, *args, **kwargs)

def build_land_deck_write_report_section(context=None, *args, **kwargs):
    return _v1_4_40_6_report("land_deck_write", "reports.legacy.land_deck_write_integration", "build_land_deck_write_report_section", context, *args, **kwargs)

def build_land_deck_write_prompt_block(context=None, *args, **kwargs):
    return _v1_4_40_6_prompt("land_deck_write", "reports.legacy.land_deck_write_integration", "build_land_deck_write_prompt_block", context, *args, **kwargs)

def build_land_deck_write_viewer_summary(context=None, *args, **kwargs):
    return _v1_4_40_6_viewer("land_deck_write", "reports.legacy.land_deck_write_integration", "build_land_deck_write_viewer_summary", context, *args, **kwargs)

def build_final_deck_export_report_section(context=None, *args, **kwargs):
    return _v1_4_40_6_report("final_deck_export", "reports.legacy.final_deck_export_integration", "build_final_deck_export_report_section", context, *args, **kwargs)

def build_final_deck_export_prompt_block(context=None, *args, **kwargs):
    return _v1_4_40_6_prompt("final_deck_export", "reports.legacy.final_deck_export_integration", "build_final_deck_export_prompt_block", context, *args, **kwargs)

def build_final_deck_export_viewer_summary(context=None, *args, **kwargs):
    return _v1_4_40_6_viewer("final_deck_export", "reports.legacy.final_deck_export_integration", "build_final_deck_export_viewer_summary", context, *args, **kwargs)

def build_v1_4_regression_report_section(context=None, *args, **kwargs):
    return _v1_4_40_6_report("v1_4_regression", "reports.legacy.strategy_v1_4_regression_lock_candidate", "build_v1_4_regression_report_section", context, *args, **kwargs)

def build_v1_4_regression_prompt_block(context=None, *args, **kwargs):
    return _v1_4_40_6_prompt("v1_4_regression", "reports.legacy.strategy_v1_4_regression_lock_candidate", "build_v1_4_regression_prompt_block", context, *args, **kwargs)

def build_v1_4_regression_viewer_summary(context=None, *args, **kwargs):
    return _v1_4_40_6_viewer("v1_4_regression", "reports.legacy.strategy_v1_4_regression_lock_candidate", "build_v1_4_regression_viewer_summary", context, *args, **kwargs)

def build_v1_4_stable_lock_report_section(context=None, *args, **kwargs):
    return _v1_4_40_6_report("v1_4_stable_lock", "reports.legacy.strategy_v1_4_stable_lock_handoff", "build_v1_4_stable_lock_report_section", context, *args, **kwargs)

def build_v1_4_stable_lock_prompt_block(context=None, *args, **kwargs):
    return _v1_4_40_6_prompt("v1_4_stable_lock", "reports.legacy.strategy_v1_4_stable_lock_handoff", "build_v1_4_stable_lock_prompt_block", context, *args, **kwargs)

def build_v1_4_stable_lock_viewer_summary(context=None, *args, **kwargs):
    return _v1_4_40_6_viewer("v1_4_stable_lock", "reports.legacy.strategy_v1_4_stable_lock_handoff", "build_v1_4_stable_lock_viewer_summary", context, *args, **kwargs)
...
def build_v1_4_40_7_player_facing_strategy_status_block(context=None):
    from reports.legacy.player_facing_version_strategy_status_correction import build_player_facing_strategy_status_block
    return build_player_facing_strategy_status_block(context or {})

def sanitize_v1_4_40_7_player_facing_report_text(text):
    from reports.legacy.player_facing_version_strategy_status_correction import sanitize_player_facing_strategy_status_text
