...
def _build_strategy_shell_section(window):
    ...
    try:
        from reports.legacy.strategy_shell_planning import build_strategy_shell_viewer_summary
...
def _build_exact_card_candidates_section(window):
    ...
    try:
        from reports.legacy.exact_card_candidate_preview import build_exact_card_candidate_viewer_summary
...
def _build_strategy_role_counts_section(window):
    ...
    try:
        from reports.legacy.strategy_role_count_generation import build_strategy_role_count_viewer_summary
...
def _build_mana_base_planning_section(window):
    ...
    try:
        from reports.legacy.mana_base_planning import build_mana_base_viewer_summary
...
def _build_land_insertion_preview_section(window):
    ...
    try:
        from reports.legacy.land_insertion_preview import build_land_insertion_viewer_summary
...
def _build_full_100_card_draft_preview_section(window):
    ...
    try:
        from reports.legacy.full_100_card_draft_preview import build_full_100_card_draft_viewer_summary
...
def _build_final_inclusion_lock_section(window):
    ...
    try:
        from reports.legacy.final_inclusion_lock import build_final_inclusion_lock_viewer_summary
...
def _build_finished_mana_base_section(window):
    ...
    try:
        from reports.legacy.finished_mana_base_generation import build_finished_mana_base_viewer_summary
...
def _build_land_deck_write_section(window):
    ...
    try:
        from reports.legacy.land_deck_write_integration import build_land_deck_write_viewer_summary
...
def _build_final_deck_export_section(window):
    ...
    try:
        from reports.legacy.final_deck_export_integration import build_final_deck_export_viewer_summary
...
def _build_old_strategy_deprecation_section(window):
    ...
    try:
        from reports.legacy.old_strategy_deprecation import build_old_strategy_deprecation_viewer_summary
...
def _build_v1_4_regression_section(window):
    ...
    try:
        from reports.legacy.strategy_v1_4_regression_lock_candidate import build_v1_4_regression_viewer_summary
...
def _build_v1_4_stable_lock_section(window):
    ...
    try:
        from reports.legacy.strategy_v1_4_stable_lock_handoff import build_v1_4_stable_lock_viewer_summary
