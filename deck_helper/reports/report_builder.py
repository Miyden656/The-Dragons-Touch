...
def build_normal_report(context: dict[str, Any]) -> str:
    ...
    lines: list[str] = [
        ...
        "",
        "Generated by v0.6.2-clean.6 modular cleanup checkpoint.",
        "",
        "> Cleanup note: this modular report is a refactor checkpoint. It is suitable for structure testing, but the legacy v0.6.2.6 monolith remains the behavior reference until parity testing is complete.",
    ]
