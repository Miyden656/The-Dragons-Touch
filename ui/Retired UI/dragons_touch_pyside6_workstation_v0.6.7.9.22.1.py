...
APP_VERSION = "v0.6.7.9.22.1"
APP_PHASE = "Report Viewer Readability Controls Cleanup"
...
class MainWindow(QMainWindow):
    ...
    def page_report_viewer(self):
        page, layout = self.page_container(
            "Report Viewer",
            f"Read generated Dragon's Touch reports with grouped files, search, word wrap, and safe file controls. {APP_VERSION} keeps report parsing plain-text for now."
        )
        body = QWidget()
