...
def build_run_analysis_page(window):
    ...
    status = QLabel("Advanced run diagnostics are available below when needed.")
    ...
    running_orb_layout.setContentsMargins(24, 24, 24, 24)
    running_orb_layout.setSpacing(16)
    running_orb_layout.addStretch(1)
    running_orb = ForgeOrb(window.theme)
    running_orb.setMinimumSize(420, 420)
    running_orb.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
    running_orb_layout.addWidget(running_orb, stretch=4, alignment=Qt.AlignCenter)
