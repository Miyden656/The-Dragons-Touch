...
Version: v0.6.7.9 — First Actual Guarded Run Path
...
APP_VERSION = "v0.6.7.9"
APP_PHASE = "First Actual Guarded Run Path"
BACKEND_STATUS = "Guarded backend bridge available — CLI/main.py remains source of truth"
...
# - v0.6.7.9 replaces the Run Analysis detail button row with a compact dropdown selector.
...
class MainWindow(QMainWindow):
    ...
    def run_config_preview_text(self):
        ...
        return (
            ...
            "- v0.6.7.9 purpose: allow the first actual guarded QProcess run of py main.py only after explicit confirmation while capturing stdout, stderr, return code, and safe failure details"
        )
    ...
    def guarded_execution_preview_text(self):
        ...
        return (
            ...
            "- Important: stdin is closed in this first bridge. If main.py requires interactive terminal input, it may exit with an input/EOF error; that result will be captured safely.\n\n"
    ...
    def guarded_execution_placeholder_message(self):
        QMessageBox.information(
            ...
            "v0.6.7.9 can attempt a guarded QProcess run of py main.py only after explicit confirmation.\n\n"
            "Use the Run main.py with Guarded Confirmation button to see the command, working directory, and safety boundary before execution."
        )
    ...
    def start_guarded_backend_run(self):
        ...
        message = (
            ...
            "- stdin is closed in this first bridge, so an interactive main.py may exit with an input/EOF error instead of waiting forever.\n\n"
            "Run py main.py now?"
        )
    ...
    def run_placeholder_message(self):
        QMessageBox.information(
            ...
            f"{APP_VERSION} has gathered staged UI choices and can run py main.py only through the guarded confirmation button. This preview button does not run the backend. Use Guarded Execution to review the command and start a confirmed run."
        )
