...
APP_VERSION = "v0.6.7.2"
APP_PHASE = "Deck File Selection"
...
class MainWindow(QMainWindow):
    ...
    def page_deck_input(self):
        ...
        quick.body.addWidget(self.make_text(
            f"{APP_VERSION} adds real local deck-file selection and preview. It does not call the analysis engine, Scryfall lookup, legality system, collection loader, or report generator yet.",
            paper=True
        ))
