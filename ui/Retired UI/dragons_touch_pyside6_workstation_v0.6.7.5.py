...
Version: v0.6.7.5.5 — Intended Bracket Selector / Review Setup Field Cleanup
...
APP_VERSION = "v0.6.7.5.5"
APP_PHASE = "Intended Bracket Selector / Review Setup Field Cleanup"
...
class MainWindow(QMainWindow):
    ...
    def page_analysis_setup(self):
        ...
        n_title = QLabel("v0.6.7.5.5 Boundary"); n_title.setObjectName("sectionTitle"); n_layout.addWidget(n_title)
    ...
    def run_config_preview_text(self):
        ...
        return (
            ...
            "- v0.6.7.5.5 purpose: stage intended bracket selection in Review Setup and run previews before a future backend bridge"
        )
    ...
    def page_run_review(self):
        ...
        stages_card = ReportCard("Future Backend Mapping Stages", self.theme, badges=[("v0.6.7.5.5", "manual")])
        stage_text = (
        ...
        b_title = QLabel("v0.6.7.5.5 Boundary"); b_title.setObjectName("sectionTitle"); b_layout.addWidget(b_title)
