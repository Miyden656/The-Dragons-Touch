...
def build_batch_reports_page(host):
    """Build the Batch Tools placeholder page."""
    self = host
    page, layout = self.page_container("Batch Tools", "Future / Not Active Yet — Batch Tools are future / not active yet. This placeholder does not run batch analysis or create aggregate reports in v0.7 alpha.")
    ...
    w_title = QLabel("Batch Tools"); w_title.setObjectName("sectionTitle"); w_layout.addWidget(w_title)
...
def build_settings_page(host):
    ...
    stable_lock_text = (
        ...
        "- Batch Tools remains a placeholder/future workspace.\n\n"
        "Next roadmap step\n"
        "- v0.7 = Desktop UI Alpha Foundation / Alpha Hardening.\n"
