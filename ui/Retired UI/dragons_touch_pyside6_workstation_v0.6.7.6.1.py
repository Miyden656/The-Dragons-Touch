...
Version: v0.6.7.6.1 — Runtime Mapping Refresh and Layout Cleanup
...
APP_VERSION = "v0.6.7.6.1"
APP_PHASE = "Runtime Mapping Refresh and Layout Cleanup"
...
class MainWindow(QMainWindow):
    ...
    def page_analysis_setup(self):
        ...
        n_title = QLabel("v0.6.7.6.1 Boundary"); n_title.setObjectName("sectionTitle"); n_layout.addWidget(n_title)
    ...
    def run_config_preview_text(self):
        ...
        return (
            ...
            "- v0.6.7.6.1 purpose: preview how staged UI values will map into a future backend runtime config and keep that preview refreshed without executing the backend"
        )
    ...
    def page_run_review(self):
        ...
        stages_card = ReportCard("Future Backend Mapping Stages", self.theme, badges=[("v0.6.7.6.1", "manual")])
        stage_text = (
        ...
        b_title = QLabel("v0.6.7.6.1 Boundary"); b_title.setObjectName("sectionTitle"); b_layout.addWidget(b_title)
