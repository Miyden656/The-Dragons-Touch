...
Version: v0.6.7.1.2 — Adventurer's Map Cartographer Palette Cleanup
...
APP_VERSION = "v0.6.7.1.2"
APP_PHASE = "Adventurer's Map Cartographer Palette Cleanup"
...
class MainWindow(QMainWindow):
    ...
    def page_deck_input(self):
        page, layout = self.page_container("Deck Selection", f"Place the deck on the forge-table. {APP_VERSION} keeps selection visual only; real file loading comes in v0.6.7.2.")
        ...
        quick = ReportCard("Forge Note", self.theme); quick.body.addWidget(self.make_text(f"{APP_VERSION} establishes the desktop shell. v0.6.7.2 should connect file selection and deck preview while leaving the locked CLI backend untouched.", paper=True))
