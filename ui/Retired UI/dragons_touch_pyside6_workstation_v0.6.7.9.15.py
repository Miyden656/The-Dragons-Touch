...
Version: v0.6.7.9.15 — Report File Detection Hardening
...
APP_VERSION = "v0.6.7.9.15"
APP_PHASE = "Report File Detection Hardening"
...
class MainWindow(QMainWindow):
    ...
    def page_run_review(self):
        ...
        boundary_card = ReportCard("Safety Boundary and Future Stages", self.theme, badges=[("v0.6.7.9.15", "manual")])
        stage_text = (
