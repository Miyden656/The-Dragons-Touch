...
Version: v0.6.7.9.10 — Deck Selection CLI Handoff and Philosophy Lens Cleanup
...
from PySide6.QtCore import Qt, QTimer, QRectF, QPointF, QSignalBlocker, QProcess, QProcessEnvironment
...
APP_VERSION = "v0.6.7.9.10"
APP_PHASE = "Deck Selection CLI Handoff and Philosophy Lens Cleanup"
BACKEND_STATUS = "Guarded backend bridge available — selected deck handoff active"
...
class MainWindow(QMainWindow):
    ...
    def guarded_execution_preview_text(self):
        ...
        return (
            ...
            "- v0.6.7.9.10 also hands the Deck Selection page file to main.py through MTG_DECK_FILE so the guarded run uses the selected UI deck.\n"
