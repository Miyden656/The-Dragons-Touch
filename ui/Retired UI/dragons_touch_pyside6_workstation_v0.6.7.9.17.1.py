...
APP_VERSION = "v0.6.7.9.19.1"
APP_PHASE = "Report Viewer Containment and Scroll Status Hotfix"
...
class MainWindow(QMainWindow):
    ...
    def page_report_viewer(self):
        ...
        viewer_layout.addWidget(report_text_card, stretch=3)
        ...
        status_card.setMaximumHeight(245)
        ...
        status_label.setMinimumHeight(78)
        status_label.setMaximumHeight(115)
