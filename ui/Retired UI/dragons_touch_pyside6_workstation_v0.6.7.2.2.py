...
Version: v0.6.7.2.2 — Deck Preview Layout and Count Cleanup
...
APP_VERSION = "v0.6.7.2.2"
APP_PHASE = "Deck Preview Layout and Count Cleanup"
...
class MainWindow(QMainWindow):
    ...
    def page_deck_input(self):
        ...
        decklist.setMinimumHeight(210)
        decklist.setMaximumHeight(260)
        ...
        # The preview remains scrollable, but the action buttons always get their own space.
        ...
        quick.body.addWidget(self.make_text(
            f"{APP_VERSION} keeps real local deck-file selection, keeps the preview box scrollable, and prevents the action buttons from overlapping the decklist preview. It does not call the analysis engine, Scryfall lookup, legality system, collection loader, or report generator yet.",
            paper=True
        ))
