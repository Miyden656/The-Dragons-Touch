...
APP_VERSION = "v0.6.7.3.3"
APP_PHASE = "Adventurer’s Map Dropdown Popup Frame Cleanup"
...
# - v0.6.7.3.3 keeps deck preview spacing, default labels, and collection handoff wording intact.
...
class MainWindow(QMainWindow):
    ...
    def page_settings(self):
        ...
        version = ReportCard("App Version", self.theme); version.body.addWidget(self.make_text(f"The Dragon’s Touch PySide6 Workstation\nVersion: {APP_VERSION}\nPhase: {APP_PHASE}\nLocked backend: {LOCKED_BACKEND_VERSION}\nBackend: Not connected in UI yet\nPurpose: local deck-file selection plus review-settings form staging, Adventurer’s Map dropdown popup frame cleanup, default labels, collection handoff clarity, and deck preview spacing cleanup", paper=True)); b_layout.addWidget(version); b_layout.addStretch(1); layout.addWidget(body, stretch=1); return page
