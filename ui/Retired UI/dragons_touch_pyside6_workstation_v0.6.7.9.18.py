...
APP_VERSION = "v0.6.7.9.18"
APP_PHASE = "Report Viewer File Load Preview"
...
class MainWindow(QMainWindow):
    ...
    def load_report_file_into_viewer(self, path_text):
        ...
        if self.report_viewer_status_label is not None:
            self.report_viewer_status_label.setText(self.report_viewer_status_text())
    ...
    def report_viewer_status_text(self):
        ...
        return (
            f"{self.state.report_viewer_current_status}\n"
            f"Current file: {self.state.report_viewer_current_file}\n"
            f"Detected report files available: {len(entries)}\n"
            f"Output folder: {self.state.last_output_folder}\n"
            "Boundary: markdown/text is loaded as plain readable text only. Deep section parsing comes later."
        )
    ...
    def page_report_viewer(self):
        ...
        status_label = QLabel(self.report_viewer_status_text())
        status_label.setObjectName("reportBody")
        ...
        report_text_card.body.addWidget(text_box)
        report_text_card.body.addWidget(self.default_note("This is a first report-viewer bridge: readable plain text now, structured navigation/markdown rendering later."))
        viewer_layout.addWidget(report_text_card, stretch=1)
