...
def build_run_analysis_page(window):
    ...
    # Idle Run Analysis intentionally has no helper-dragon loading canvas.
    # The animated forge/dragon visual is reserved for active guarded backend runs only.
    ...
    boundary_card = ReportCard("Safety Boundary and Future Stages", window.theme, badges=[("v0.8.8.2.4", "manual")])
    stage_text = (
    ...
    running_layout.setContentsMargins(34, 34, 34, 34)
    ...
    running_orb_layout.setContentsMargins(28, 28, 28, 28)
    running_orb_layout.setSpacing(18)
    running_orb = ForgeOrb(window.theme)
    running_orb.setMinimumSize(560, 560)
    running_orb.setMaximumSize(760, 760)
    ...
    running_orb_layout.addStretch(1)
    ...
    running_orb_layout.addWidget(running_status, stretch=0, alignment=Qt.AlignHCenter | Qt.AlignBottom)
