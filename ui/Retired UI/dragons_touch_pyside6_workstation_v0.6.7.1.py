...
Version: v0.6.7.1 — Desktop UI Shell / Navigation Foundation
...
APP_VERSION = "v0.6.7.1"
APP_PHASE = "Desktop UI Shell / Navigation Foundation"
...
class MainWindow(QMainWindow):
    ...
    def page_settings(self):
        ...
        prefs = ReportCard("Prototype Preferences", self.theme); pref_grid = QGridLayout(); pref_grid.addWidget(QLabel("Report Detail Level"), 0, 0); detail = QComboBox(); detail.addItems(["Short", "Normal", "Detailed", "Exhaustive"]); detail.setCurrentText("Detailed"); pref_grid.addWidget(detail, 0, 1); pref_grid.addWidget(QLabel("Export Format"), 1, 0); export = QComboBox(); export.addItems(["Markdown", "Text", "HTML later", "PDF later"]); pref_grid.addWidget(export, 1, 1); pref_grid.addWidget(QLabel("Save Folder"), 2, 0); pref_grid.addWidget(QLineEdit("Outputs/"), 2, 1); prefs.body.addLayout(pref_grid); b_layout.addWidget(prefs)
