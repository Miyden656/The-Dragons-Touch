...
Version: v0.6.8.3 — Final User-Facing Boundary Cleanup
...
APP_VERSION = "v0.6.8.3"
APP_PHASE = "Final User-Facing Boundary Cleanup"
BACKEND_STATUS = "v0.6.8.3 polish — guarded UI bridge uses CLI/main.py as source of truth"
...
class MainWindow(QMainWindow):
    ...
    def page_settings(self):
        ...
        version_text = (
            ...
            "Foundation status -> v0.6.7 Desktop UI Foundation locked; v0.6.8.3 user-facing boundary cleanup active\n"
