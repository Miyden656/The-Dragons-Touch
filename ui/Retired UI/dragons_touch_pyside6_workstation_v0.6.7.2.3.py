...
APP_VERSION = "v0.6.7.2.3"
APP_PHASE = "Deck Preview Button Spacing Cleanup"
...
class MainWindow(QMainWindow):
    ...
    def page_deck_input(self):
        ...
        decklist.setMinimumHeight(150)
        decklist.setMaximumHeight(170)
        decklist.setFixedHeight(165)
        ...
        quick.body.addWidget(self.make_text(
            f"{APP_VERSION} keeps real local deck-file selection, keeps the preview box intentionally constrained, and gives the action buttons their own space below the decklist preview. It does not call the analysis engine, Scryfall lookup, legality system, collection loader, or report generator yet.",
            paper=True
        ))
