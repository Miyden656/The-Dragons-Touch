...
Version: v0.6.7.8.1 — Run Analysis Detail Selector Layout Cleanup
...
APP_VERSION = "v0.6.7.8.1"
APP_PHASE = "Run Analysis Detail Selector Layout Cleanup"
...
class MainWindow(QMainWindow):
    ...
    def page_run_review(self):
        ...
        boundary_card = ReportCard("Safety Boundary and Future Stages", self.theme, badges=[("v0.6.7.8.1", "manual")])
        stage_text = (
