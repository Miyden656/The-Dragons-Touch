...
Version: v0.6.7.2 — Deck File Selection
...
APP_VERSION = "v0.6.7.2.1"
APP_PHASE = "Deck Preview Layout Cleanup"
...
class MainWindow(QMainWindow):
    ...
    def page_deck_input(self):
        ...
        decklist.setMinimumHeight(300)
        decklist.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        ...
        quick.body.addWidget(self.make_text(
            f"{APP_VERSION} keeps real local deck-file selection and cleans up the deck preview layout. It does not call the analysis engine, Scryfall lookup, legality system, collection loader, or report generator yet.",
            paper=True
        ))
