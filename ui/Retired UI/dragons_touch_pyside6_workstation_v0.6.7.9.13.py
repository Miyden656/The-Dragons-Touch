...
APP_VERSION = "v0.6.7.9.13"
APP_PHASE = "Companion Preview Detection and Handoff Status"
...
class MainWindow(QMainWindow):
    ...
    def guarded_execution_preview_text(self):
        ...
        return (
            ...
            "- v0.6.7.9.13 keeps the Deck Selection handoff, normalizes collection folder/file readiness, and previews companion sections without validating companion legality.\n"
