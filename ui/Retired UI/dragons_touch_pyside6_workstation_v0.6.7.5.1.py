...
Version: v0.6.7.5 — Run Analysis Backend Hook Preparation
...
APP_VERSION = "v0.6.7.5"
APP_PHASE = "Run Analysis Backend Hook Preparation"
...
class MainWindow(QMainWindow):
    ...
    def run_config_preview_text(self):
        ...
        return (
            ...
            "- v0.6.7.5 purpose: confirm the UI has enough staged information before a future backend bridge"
        )
    ...
    def page_run_review(self):
        ...
        stages_card = ReportCard("Future Backend Mapping Stages", self.theme, badges=[("v0.6.7.5", "manual")])
        stage_text = (
        ...
        b_title = QLabel("v0.6.7.5 Boundary"); b_title.setObjectName("sectionTitle"); b_layout.addWidget(b_title)
        b_layout.addWidget(self.make_text("This patch prepares the backend hook by gathering staged UI choices in one place. It does not run analysis, load Scryfall, validate legality, load a collection, or write reports."))
