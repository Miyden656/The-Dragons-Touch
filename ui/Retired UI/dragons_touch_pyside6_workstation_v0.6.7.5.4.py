...
Version: v0.6.7.5.3 — Flash Popup Cleanup / Auto-Stage Quiet Mode
...
APP_VERSION = "v0.6.7.5.3"
APP_PHASE = "Flash Popup Cleanup / Auto-Stage Quiet Mode"
...
class MainWindow(QMainWindow):
    ...
    def run_config_preview_text(self):
        ...
        return (
            ...
            "- v0.6.7.5.3 purpose: keep auto-staging quiet by updating visible collection and theme widgets in place before a future backend bridge"
        )
    ...
    def page_collection_tools(self):
        ...
        current_source_box = self.readonly_text_box(self.collection_settings_summary_text(), min_height=132, max_height=170)
        self.collection_preview_boxes.append(current_source_box)
        current_source.body.addWidget(current_source_box)
