...
def build_markdown_summary(
    *,
    ...
    lines: list[str] = [
        "# v1.4-expanded-strategy-scoring — Isolated Combo Matcher Summary",
        "",
        "## Scope Guard",
        "",
...
def build_combo_breakdown_markdown(
    *,
    ...
    lines: list[str] = [
        "# v1.4-expanded-strategy-scoring — Commander Spellbook Combo Awareness Breakdown",
        "",
        "## Scope Guard",
        "",
        "- No API calls were made.",
    ...
    lines.extend([
        ...
        "- This v1.4-expanded-strategy-scoring breakdown should remain isolated until a later report integration patch intentionally connects it.",
        "",
    ])
...
# v1.4-expanded-strategy-scoring handoff polish note retained for future prompt/report wording.
