...
def build_diagnostics_debug_section(context: dict[str, Any]) -> str:
    ...
    if philosophy_context:
        ...
        lines.extend([
            ...
            "- Cut scoring changed by philosophy: Yes — v0.6.6.2 light optional-cut bias is active",
            ...
            "- Current philosophy scoring phase: v0.6.6.2 Philosophy-Aware Optional Cut Bias",
            ...
            "- Foundation boundary: v0.6.6.2 applies only small optional-cut nudges. It does not alter legality, required cuts, strategy detection, collection matching, or replacement scoring.",
            ...
            "",
            "## v0.6.6.2 Philosophy-Aware Optional Cut Bias",
            "- v0.6.6.2 optional-cut bias active: Yes",
