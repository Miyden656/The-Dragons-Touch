...
def _build_collection_pull_section(context: dict[str, Any]) -> list[str]:
    ...
    lines.extend([
        ...
        "> v0.6.6.5.1 philosophy-bias overactivity cleanup is active: candidate presentation may be lightly nudged, overbroad cut-bias aliases are suppressed, visibility counters/examples are recorded, and the system still cannot force bad recommendations or override collection-only mode.",
