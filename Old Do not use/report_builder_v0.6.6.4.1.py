...
def _build_collection_pull_section(context: dict[str, Any]) -> list[str]:
    ...
    lines.extend([
        ...
        "> v0.6.6.4.1 philosophy-aware replacement bias may nudge candidate presentation, records visibility counters/examples, and cannot force bad recommendations or override collection-only mode.",
