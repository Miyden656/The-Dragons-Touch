...
def build_diagnostics_debug_section(context: dict[str, Any]) -> str:
    ...
    if philosophy_context:
        ...
        lines.extend([
            ...
            "- Cut scoring changed by philosophy: Yes — v0.6.6.2.2 light optional-cut bias is active",
            ...
            "- Current philosophy scoring phase: v0.6.6.2.2 Philosophy Bias Counter / Infrastructure Suppression Hotfix",
            ...
            "- Foundation boundary: v0.6.6.2.2 applies only small optional-cut nudges and adds unique-card counters and suppresses confusing mana-base infrastructure review-pressure notes. It does not alter legality, required cuts, strategy detection, collection matching, or replacement scoring.",
