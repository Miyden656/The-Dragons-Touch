...
def build_diagnostics_debug_section(context: dict[str, Any]) -> str:
    ...
    if philosophy_context:
        ...
        lines.extend([
            ...
            "- Current philosophy scoring phase: v0.6.6.5.2 Balanced Neutrality and Companion Review Wording Cleanup",
            ...
            "- Foundation boundary: v0.6.6.5.2 keeps small optional-cut nudges, completed protected/watch-card report fields, replacement-bias visibility, and adds balanced-neutrality cleanup before v0.6.6 lock. It does not alter legality, required cuts, strategy detection, collection mode, color identity, companion restrictions, or quality gates.",
            ...
            "- v0.6.6.5.2 QA status: replacement-bias counters remain active and overbroad cut-bias aliases are tightened.",
            ...
            "",
            "## v0.6.6.5.2 Balanced Neutrality and Companion Review Wording Cleanup",
            "- v0.6.6.5.2 balanced-neutrality and companion-review cleanup active: Yes",
            "- Purpose: verify that philosophy bias helps explanation without becoming a hard override, while companion reports distinguish manual review from automated violations.",
