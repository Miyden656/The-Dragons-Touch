...
def render_philosophy_diagnostics_section(context: dict) -> str:
    ...
    lines = [
        ...
        "- Boundary: Philosophy/persona is guidance only; it does not alter legality, deck size, color identity, strategy detection, required cuts, or collection matching in v0.6.5.1.",
        "- v0.6.5.1 report guidance active: Yes",
        "- Guidance scope: normal report framing and diagnostics only; no cut-score or replacement-score changes yet.",
    ]
