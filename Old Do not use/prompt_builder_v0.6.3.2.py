...
def _global_prompt_rules(context: dict[str, Any]) -> list[str]:
    return [
        ...
        "   - Companion Verification Warning, if the report detected a possible companion in reference/non-mainboard cards",
        ...
        "7. If a Companion Verification Warning is present, ask the pilot to confirm whether each listed card is: 1. Companion, 2. Sideboard/maybeboard, or 3. Reference-only.",
        "8. If a companion is confirmed, apply that companion restriction to every cut, build, replacement, and recommendation decision. Do not recommend cards that would break the confirmed companion restriction.",
        "9. If the Reference / Non-Mainboard / Ignored Cards section contains cards but there is no companion warning, still ask whether any listed card is intended as a companion, sideboard/maybeboard card, or reference-only card before final recommendations.",
        "10. Give a brief initial summary of what the report appears to say: commander, deck size, legality/cut pressure, primary strategy, secondary strategy, and any obvious mismatch to verify.",
        "",
        "### Phase 2 — Guide Introduction",
        "",
        f"11. {_philosophy_intro_instruction(context)}",
        "",
        "### Phase 3 — Section-by-Section Intake",
        "",
        "12. Then immediately ask Section 1 only. Do not ask multiple sections at once in interactive mode.",
        "13. The user may answer using just numbers, short phrases, or N/A. Accept numbered answers without forcing long explanations.",
        "14. After each section, summarize the user's answers in 3 to 6 bullets, then immediately ask the next section.",
        "15. Do not make final cut, addition, or replacement recommendations until all required sections are complete.",
        "",
        "### Phase 4 — Final Intent Summary",
        "",
        "16. Do not assume the script's strategy read is correct if the pilot corrects it.",
        "17. Separate required legality cuts from optional optimization cuts.",
        "18. Do not recommend cutting cards the pilot refuses to cut.",
        "19. Treat bracket pressure as table-fit information, not an automatic cut.",
        "20. Do not recommend cards already in the deck unless the card is a legal duplicate exception.",
        "21. Before final recommendations, provide a full intent summary titled '<Commander Name> Review Intent Summary' and ask the user to confirm or correct it.",
        "",
        "### Phase 5 — Final Recommendations",
        "",
        "22. Only after confirmation should you produce the final recommendations in the user's selected output style.",
        "23. Final recommendations are decision support, not final authority. The pilot makes the final keep/cut/build decisions.",
    ]
