...
def build_diagnostics_debug_section(context: dict[str, Any]) -> str:
    ...
    if philosophy_context:
        ...
        lines.extend([
            ...
            "- Replacement scoring changed by philosophy: Yes — v0.6.6.4 light replacement-candidate bias is active",
            "- Strategy detection changed by philosophy: No",
            "- Collection candidate matching changed by philosophy: No",
            "- Current philosophy scoring phase: v0.6.6.4 Philosophy-Aware Replacement Bias",
            ...
            "- Foundation boundary: v0.6.6.4 applies small optional-cut nudges, completed protected/watch-card report fields, and light replacement-candidate presentation/order bias. It does not alter legality, required cuts, strategy detection, collection mode, color identity, companion restrictions, or quality gates.",
            ...
            "",
            "## v0.6.6.4 Philosophy-Aware Replacement Bias",
            "- v0.6.6.4 replacement bias active: Yes",
            "- Applies to: collection candidate presentation and light ordering nudges only",
    ...
    if collection_candidates:
        lines.extend([
            ...
            "- v0.6.6.4 replacement bias active: " + ("Yes" if getattr(collection_candidates, 'replacement_bias_active', False) else "No"),
            ...
            f"- Replacement-biased candidates nudged: {getattr(collection_candidates, 'replacement_bias_adjusted_cards', 0)}",
