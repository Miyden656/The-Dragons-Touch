...
def _global_prompt_rules(context: dict[str, Any]) -> list[str]:
    return [
        ...
        "7. If the Reference / Non-Mainboard / Ignored Cards section contains cards, ask whether any listed card is intended as a companion, sideboard/maybeboard card, or reference-only card before final recommendations.",
        "8. Give a brief initial summary of what the report appears to say: commander, deck size, legality/cut pressure, primary strategy, secondary strategy, and any obvious mismatch to verify.",
        "",
        "### Phase 2 — Guide Introduction",
        "",
        f"9. {_philosophy_intro_instruction(context)}",
        "",
        "### Phase 3 — Section-by-Section Intake",
        "",
        "10. Then immediately ask Section 1 only. Do not ask multiple sections at once in interactive mode.",
        "11. The user may answer using just numbers, short phrases, or N/A. Accept numbered answers without forcing long explanations.",
        "12. After each section, summarize the user's answers in 3 to 6 bullets, then immediately ask the next section.",
        "13. Do not make final cut, addition, or replacement recommendations until all required sections are complete.",
        "",
        "### Phase 4 — Final Intent Summary",
        "",
        "14. Do not assume the script's strategy read is correct if the pilot corrects it.",
        "15. Separate required legality cuts from optional optimization cuts.",
        "16. Do not recommend cutting cards the pilot refuses to cut.",
        "17. Treat bracket pressure as table-fit information, not an automatic cut.",
        "18. Do not recommend cards already in the deck unless the card is a legal duplicate exception.",
        "19. Before final recommendations, provide a full intent summary titled '<Commander Name> Review Intent Summary' and ask the user to confirm or correct it.",
        "",
        "### Phase 5 — Final Recommendations",
        "",
        "20. Only after confirmation should you produce the final recommendations in the user's selected output style.",
        "21. Final recommendations are decision support, not final authority. The pilot makes the final keep/cut/build decisions.",
    ]
