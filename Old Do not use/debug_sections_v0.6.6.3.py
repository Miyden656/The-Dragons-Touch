...
def build_diagnostics_debug_section(context: dict[str, Any]) -> str:
    ...
    if philosophy_context:
        ...
        lines.extend([
            ...
            "- Cut scoring changed by philosophy: Yes — v0.6.6.3 light optional-cut bias and protected/watch wording are active",
            ...
            "- Current philosophy scoring phase: v0.6.6.3 Philosophy-Aware Protected / Watch Card Language",
            ...
            "- Foundation boundary: v0.6.6.3 applies only small optional-cut nudges plus clearer protected/watch-card wording. It does not alter legality, required cuts, strategy detection, collection matching, or replacement scoring.",
            ...
            "",
            "## v0.6.6.3 Philosophy-Aware Protected / Watch Card Language",
            "- v0.6.6.3 protected/watch language active: Yes",
