...
def build_diagnostics_debug_section(context: dict[str, Any]) -> str:
    ...
    if philosophy_context:
        ...
        lines.extend([
            ...
            "- Current philosophy scoring phase: v0.6.6.3.1 Protected Watch Language Field Completion Hotfix",
            ...
            "- Foundation boundary: v0.6.6.3.1 applies only small optional-cut nudges plus completed protected/watch-card report fields. It does not alter legality, required cuts, strategy detection, collection matching, or replacement scoring.",
