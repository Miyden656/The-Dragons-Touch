...
def _global_prompt_rules(context: dict[str, Any]) -> list[str]:
    return [
        ...
        "8. If a Companion Verification Warning is present, ask the pilot to confirm whether each listed card is: 1. Companion, 2. Sideboard/maybeboard, or 3. Reference-only.",
        "9. If a companion is confirmed during the guided review, apply that companion restriction to every cut, build, replacement, and recommendation decision. Do not recommend cards that would break the confirmed companion restriction.",
        ...
        "11. If a confirmed or user-confirmed companion has a recommendation filter in the report, treat that filter as a hard recommendation constraint unless the pilot explicitly removes the companion requirement.",
        ...
        "",
        f"13. {_philosophy_intro_instruction(context)}",
        "",
        "### Phase 3 — Section-by-Section Intake",
        "",
        "14. Then immediately ask Section 1 only. Do not ask multiple sections at once in interactive mode.",
        "15. The user may answer using just numbers, short phrases, or N/A. Accept numbered answers without forcing long explanations.",
        "16. After each section, summarize the user's answers in 3 to 6 bullets, then immediately ask the next section.",
        "17. Do not make final cut, addition, or replacement recommendations until all required sections are complete.",
        "",
        "### Phase 4 — Final Intent Summary",
        "",
        "18. Do not assume the script's strategy read is correct if the pilot corrects it.",
        "19. Separate required legality cuts from optional optimization cuts.",
        "20. Do not recommend cutting cards the pilot refuses to cut.",
        "21. Treat bracket pressure as table-fit information, not an automatic cut.",
        "22. Do not recommend cards already in the deck unless the card is a legal duplicate exception.",
        "23. Before final recommendations, provide a full intent summary titled '<Commander Name> Review Intent Summary' and ask the user to confirm or correct it.",
        "",
        "### Phase 5 — Final Recommendations",
        "",
        "24. Only after confirmation should you produce the final recommendations in the user's selected output style.",
        "25. Final recommendations are decision support, not final authority. The pilot makes the final keep/cut/build decisions.",
    ]
