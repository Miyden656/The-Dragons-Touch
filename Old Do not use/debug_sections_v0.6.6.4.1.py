...
def build_diagnostics_debug_section(context: dict[str, Any]) -> str:
    ...
    if philosophy_context:
        ...
        lines.extend([
            ...
            "- Replacement scoring changed by philosophy: Yes — v0.6.6.4.1 replacement-bias visibility and role-alias cleanup is active",
            "- Strategy detection changed by philosophy: No",
            "- Collection candidate matching changed by philosophy: No",
            "- Current philosophy scoring phase: v0.6.6.4.1 Replacement Bias Visibility and Role-Alias Cleanup",
            ...
            "- Foundation boundary: v0.6.6.4.1 applies small optional-cut nudges, completed protected/watch-card report fields, light replacement-candidate presentation/order bias, visibility counters, and role-alias cleanup. It does not alter legality, required cuts, strategy detection, collection mode, color identity, companion restrictions, or quality gates.",
            ...
            "",
            "## v0.6.6.4.1 Replacement Bias Visibility and Role-Alias Cleanup",
            "- v0.6.6.4.1 replacement bias visibility active: Yes",
            ...
            "- Role-alias cleanup active: Yes — human-facing philosophy terms such as reliable enablers, focused setup, and survival interaction can map to concrete card roles.",
    ...
    if collection_candidates:
        lines.extend([
            ...
            "- v0.6.6.4.1 replacement bias visibility active: " + ("Yes" if getattr(collection_candidates, 'replacement_bias_active', False) else "No"),
